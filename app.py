...
@app.route('/api/chat/delete-history', methods=['POST'])
@login_required
...
@app.route('/api/account/change-nick', methods=['POST'])
@login_required
def change_nick():
...
@app.route('/api/account/generate-recovery', methods=['POST'])
@login_required
...
@app.route('/api/account/panic', methods=['POST'])
@login_required
def panic_lock():
...
@app.route('/api/admin/user/<user_id>/reduce-ban', methods=['POST'])
@login_required
...
@app.route('/api/admin/user/<user_id>/change-ban-type', methods=['POST'])
@login_required
...
@app.route('/api/admin/user/<user_id>/change-password', methods=['POST'])
@login_required
...
@app.route('/api/admin/user/<user_id>/generate-recovery', methods=['POST'])
@login_required
...
@app.route('/api/admin/user/<user_id>/unlock-panic', methods=['POST'])
@login_required
...
@app.route('/api/admin/user/<user_id>/set-role', methods=['POST'])
@login_required
...
@app.route('/api/admin/system-message', methods=['POST'])
@login_required
def admin_system_message():
    ...
    if target == 'all':
        ...
        for u in users:
            send_system_message(u.id, message)
    else:
